...
CSRF_COOKIE_SECURE = True  # Assurez-vous que cela est activé si vous utilisez HTTPS
...
INSTALLED_APPS = [
    ...
    "cheeseapi.home",
    "cheeseapi.images",
    "cheeseapi.navigation",
    "cheeseapi.news",
    "cheeseapi.search",
    "cheeseapi.standardpages",
    "cheeseapi.users",
    "cheeseapi.utils",
...
WSGI_APPLICATION = "cheeseapi.wsgi.application"
